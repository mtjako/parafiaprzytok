export const Contact = () => {
    return(
        ...
        <div className="mt-9">
          <div className="flex">
            ...
            <p className="text-gray-600 font-bold text-lg">Numer Telefonu</p>
              <p>
              68 323 06 41
              </p>
              <p className="mt-1">
          ...
          <div className="mt-6 flex">
            ...
            <div className="ml-3 text-base text-gray-500">
            <p className="text-gray-600 font-bold text-lg">Email</p>
              <p>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
            ...
            <div className="ml-3 text-base text-gray-500 ">
            <p className="text-gray-600 font-bold text-lg">Numer Konta</p>
              <p>
...
<svg className="h-6 w-6 text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
            ...
            <div className="ml-3 text-base text-gray-500">
            <p className="text-gray-600 font-bold text-lg">Adres</p>
              <p>
